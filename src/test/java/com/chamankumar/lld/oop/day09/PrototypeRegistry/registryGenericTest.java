...
import chamankumar.lld.oop.day09.PrototypeRegistry.assignmentSolution.registryGenerics;
...
/**
 * The `registryGenericTest` class contains JUnit test cases to verify the functionality
 * of the generic registry implementation (`registryGenerics`) and the Prototype Design Pattern.
 */
public class registryGenericTest {

    // Generic registry to store and retrieve prototypes
    private registryGenerics<IdentityUserObject, IdentityUserObjectType> registry;

    /**
     * Sets up the test environment by initializing the generic registry and storing a prototype.
     * This method is executed before each test.
     */
    @BeforeEach
    public void setUp() {
        registry = new registryGenerics<>();
