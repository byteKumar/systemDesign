 ...
 * - This interface is focused solely on swimming behavior, ensuring that classes implementing it are not forced to implement unrelated methods.
...
public interface Swimmable {
    ...
    /**
     * Method to define swimming behavior.
